...
function echoDown(str,num) {
		...
		for(var i=0;i<s.length;i++){
            ...
            var innerStr = '<li><div class="{$maccms.cache_flag} feifan123"><input type="checkbox" value=\"' + gurl[1] + '\"  name="CopyAddr' + num + '" style="vertical-align:middle" class="{$maccms.cache_flag} ' + num + 'addr"/><div class="{$maccms.cache_flag} dinput"><span id="s' + num + 'p' + i + '">' + gurl[3] + '</span><input type="text" value="' + gurl[1] + '" style="vertical-align:middle" id="lin' + num + 'k' + i + '"/></div></div><div class="{$maccms.cache_flag} dwon_xl"><a target=\"_self\" href=\"' + thunderUrl + '\" thUrl=\"'+thunderUrl+'\" mc=\"\" title="\u8fc5\u96f7\u4e0b\u8f7d" id="'+num+'thUrlid'+i+'" class="{$maccms.cache_flag} dwon'+num+'">\u8fc5\u96f7\u4e0b\u8f7d</a></div><div class="{$maccms.cache_flag} dwon_tx"><a class=\"qq-down\" href=\"' + gurl[2] + '\" qhref=\"'+gurl[2]+'\" filename=\"\" title="\u65cb\u98ce\u4e0b\u8f7d" target="_self">\u65cb\u98ce\u4e0b\u8f7d</a></div><div class="{$maccms.cache_flag} dwon_xm"><a href=\"https://d.miwifi.com/d2r/?url=' + encode64(thunderUrl) + '\" title="\u5c0f\u7c73\u4e0b\u8f7d">\u5c0f\u7c73\u4e0b\u8f7d</a></div><div class="{$maccms.cache_flag} dwon_y"><a href=\"javascript:video(0);\" onclick=\"start(\'' + gurl[1] + '\')\" title="\u8fc5\u96f7\u5f71\u97f3" target="_self">\u8fc5\u96f7\u5f71\u97f3</a></div></li>';
