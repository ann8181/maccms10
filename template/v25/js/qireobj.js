...
jQuery.showfloatdiv = function(ox) {
    ...
    if (oxdefaults.wantclose == 1) {
        var floatdiv = $('<div class="{$maccms.cache_flag} qirebox-overlayBG" id="qirebox_overlay"></div><div id="qirebox" class="{$maccms.cache_flag} qirebox png-img"><iframe frameborder="0" class="{$maccms.cache_flag} ui-iframe"></iframe><table class="{$maccms.cache_flag} ui-dialog-box"><tr><td><div class="{$maccms.cache_flag} ui-dialog"><div class="{$maccms.cache_flag} ui-dialog-cnt" id="ui-dialog-cnt"><div class="{$maccms.cache_flag} ui-dialog-tip alert" id="ui-cnt"><span id="xtip">' + oxdefaults.txt + '</span></div></div><div class="{$maccms.cache_flag} ui-dialog-close"><span class="{$maccms.cache_flag} close">关闭</span></div></div></td></tr></table></div>');
        ...
        var idval = (id.attributes["data"].nodeValue != null && id.attributes["data"].nodeValue != undefined) ? id.attributes["data"].nodeValue: id.data;
        var floatdiv = $('<div class="{$maccms.cache_flag} qirebox-overlayBG" id="qirebox_overlay"></div><div id="qirebox" class="{$maccms.cache_flag} qirebox png-img"><iframe frameborder="0" class="{$maccms.cache_flag} ui-iframe"></iframe><table class="{$maccms.cache_flag} ui-dialog-box"><tr><td><div class="{$maccms.cache_flag} ui-dialog"><div class="{$maccms.cache_flag} ui-dialog-cnt" id="ui-dialog-cnt"><div class="{$maccms.cache_flag} ui-dialog-tip alert" id="ui-cnt"><span id="xtip">' + oxdefaults.txt + '</span></div></div><div class="{$maccms.cache_flag} ui-dialog-todo"><a class="{$maccms.cache_flag} ui-link ui-link-small" href="javascript:void(0);" id="surebt">确定</a><a class="{$maccms.cache_flag} ui-link ui-link-small cancelbt"  id="cancelbt">取消</a><input type="hidden" id="hideval" value=""/></div><div class="{$maccms.cache_flag} ui-dialog-close"><span class="{$maccms.cache_flag} close">关闭</span></div></div></td></tr></table></div>');
        $("body").append(floatdiv);
        $("#qirebox_overlay").fadeIn(500);
        $("#qirebox").fadeIn(500);
        $(".ui-dialog-close").click(function() {
        ...
        var floatdiv = $('<div class="{$maccms.cache_flag} qirebox_overlayBG" id="qirebox_overlay"></div><div id="qirebox" class="{$maccms.cache_flag} qirebox"><iframe frameborder="0" class="{$maccms.cache_flag} ui-iframe"></iframe><div class="{$maccms.cache_flag} ui-dialog"><div class="{$maccms.cache_flag} ui-dialog-cnt" id="ui-dialog-cnt"><div class="{$maccms.cache_flag} ui-dialog-box"<div class="{$maccms.cache_flag} ui-cnt" id="ui-cnt">' + oxdefaults.txt + '</div></div></div></div></div>');
        $("body").append(floatdiv);
        $("#qirebox_overlay").fadeIn(500);
        $("#qirebox").fadeIn(500);
    }
