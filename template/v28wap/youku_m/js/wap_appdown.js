...
// })();
// function ppsr(exp){	 	$.cookie('appdw', 'ok', {expires: exp, path: '/'});if(exp>1){window.open("http://v28.qin52.com/");}$("#appdwn").hide(); }
