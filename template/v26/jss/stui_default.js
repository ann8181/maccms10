...
var stui = {
	...
	mobile: {
		...
		slide: function() {
			$.getScript(maccms.path+"/template/xingxinv10/jss/flickity.pkgd.min.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript(maccms.path+"/template/xingxinv10/jss/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
	...
	common: {
		bootstrap: function() {
			$.getScript(maccms.path+"/template/xingxinv10/jss/bootstrap.min.js", function() {
		...
		headroom: function() {
			$.getScript(maccms.path+"/template/xingxinv10/jss/headroom.min.js", function() {
				$("#header-top", function() {
